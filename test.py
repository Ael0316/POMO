...
SDM5031_ROOT = os.path.abspath(os.path.join(SCRIPT_DIR, "../../../.."))
...
DEFAULT_DATA_PATH = os.path.join(SDM5031_ROOT, "TSP", "data", "val")
DEFAULT_MODEL_DIR = "./result/saved_tsp100_po"
DEFAULT_MODEL_EPOCH = 2010
...
def build_parser():
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate a PO TSP model on a directory of TSPLIB instances. "
...
def build_logger_params(args, tester_params):
    ...
    return {
        "log_file": {
            "desc": f"{highlight}_test_TSPLIB_PO",
